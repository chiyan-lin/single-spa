(function (global) {
    ...
    function getContainer(container) {
        ...
        throw new Error('singleSpaReact passed container must be a string or function');
    }
    ...
    global.singleSpaReact = function (options) {
        if (typeof options !== 'object') {
            throw new Error('singleSpaReact options must be a object');
        }

        let opts = Object.assign({}, defaultOpts, options);

        if (!options.React) {
            throw new Error('singleSpaReact must be passed a React');
        }

        if (!options.ReactDOM) {
            throw new Error('singleSpaReact must be passed a ReactDOM');
        }

        if (!options.rootComponent) {
            throw new Error('singleSpaReact must be passed a rootComponent');
        }

        if (!options.container) {
            throw new Error('singleSpaReact must be passed a container');
        }
