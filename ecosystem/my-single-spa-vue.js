(function (global) {
    ...
    global.singleSpaVue = function (options) {
        if (typeof options !== 'object') {
            throw new Error('singleSpaVue options must be a object');
        }

        let opts = Object.assign({}, defaultOpts, options);

        if (!options.Vue) {
            throw new Error('singleSpaVue must be passed a Vue');
        }

        if (!options.appOptions) {
            throw new Error('singleSpaVue must be passed a appOptions');
        }
